...
for (const script of ["build-feed.mjs", "build-episodes.mjs", "build-blog.mjs", "build-blog-rss.mjs", "build-videos.mjs", "build-merch.mjs", "build-quiz.mjs", "build-glossary.mjs", "build-meta.mjs", "build-sitemap.mjs", "build-status.mjs"]) {
